...
\vfill
\item
\textgood{Supporting Advanced Patterns in GrPPI: a Generic Parallel Pattern Interface}.
D. R. del Astorga, M. F. Dolz, J. Fernandez, and J. D. Garcia, 
Auto-DaSP 2017 (Euro-Par 2017).
\item
\textgood{Probabilistic-Based Selection of Alternate Implementations for Heterogeneous Platforms}.
J. Fernandez, A. Sanchez, D. del Río, M. F. Dolz, J. D Garcia.
ICA3PP 2017.
2017.
\item
\textgood{A C++ Generic Parallel Pattern Interface for Stream Processing}. 
D. del Río, M. F. Dolz, L. M. Sanchez, J. Garcia-Blas and J. D. Garcia. 
ICA3PP 2016.
\item
\textgood{Finding parallel patterns through static analysis in C++ applications}.
